...
function zameniRec(recenica, rec) {
  var regex = new RegExp(rec, "g");

  var rezultat = recenica.replace(regex, "#");

  return rezultat;
}

var recenica = "Danas je lep dan.";
var rec = "lep";

var rezultat = zameniRec(recenica, rec);
...
console.log(duzinaBezRazmaka("Hello, World!"));
